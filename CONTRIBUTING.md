# Contributing to donejs-input-number-new

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/Piyush5767/donejs-input-number-new) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork donejs-input-number-new, you can start by going to its [fork page](https://github.com/Piyush5767/donejs-input-number-new/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/donejs-input-number-new
```
